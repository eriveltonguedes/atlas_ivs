...
<link rel="stylesheet" type="text/css" href="<?php echo $path_dir ?>assets/css/hdi.css" media="screen" />

<!-- Raphael Library -->
<script type="text/javascript" src="<?php echo $path_dir ?>system/modules/hdi/js/raphael.js"></script>
<script type="text/javascript" src="<?php echo $path_dir ?>system/modules/hdi/js/raphael.serialize.js"></script> 

<!-- Javascript for HDI  --> 
<script type="text/javascript" src="<?php echo $path_dir ?>system/modules/hdi/js/hdi_tree.js"></script>
<!-- Problema --------------------------------------------------------  -->
<script type="text/javascript" src="<?php echo $path_dir ?>system/modules/hdi/js/hdi_onload.js"></script>

<?php
    include_once '../system/modules/hdi/getMunicipios.php'; 
    //include_once './config/conexao.class.php';
    include_once '../system/modules/hdi/getUrl.php';  
?>
...
//    console.log(municipio1Arvore);
    var municipio2Arvore = '<?=$municipio2Arvore?>';
//    console.log(municipio2Arvore);
