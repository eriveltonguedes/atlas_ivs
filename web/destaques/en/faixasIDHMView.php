<div class="destaqueFaixasIDHM">
    ...
    <div class="direita1Faixas floatLeft">
        ...
        Brazil:<br />
        <img src="./assets/img/destaques/seta.png" class="setaList"><b>High</b> and <b>Medium</b><br />
        <span class="marginLeft20">74% of the municipalities</span>
        <p>
            <img src="./assets/img/destaques/seta.png" class="setaList"><b>Low</b> and <b>Very Low</b><br />
            <span class="marginLeft20">25% of the municipalities</span>
        </p>
        <p>
            <img src="./assets/img/destaques/seta.png" class="setaList"><b>Very Low</b><br />
        ...
        <div class="floatLeft">
            ...
            <img src="./assets/img/destaques/seta.png" class="setaList"><b>High </b> (65%)<br />
            <p>
                <span class="marginLeft20">Southeast</span><br />
                <img src="./assets/img/destaques/seta.png" class="setaList"><b>High</b> (52%)<br />
            </p>
        </div>
        <div class="floatRight" style="margin-right: 100px;">
            <span class="marginLeft20">Central-West</span><br />
            <img src="./assets/img/destaques/seta.png" class="setaList"><b>Medium</b> (57%)<br />
            <p>
                <span class="marginLeft20">North</span><br />
                <img src="./assets/img/destaques/seta.png" class="setaList"><b>Medium</b> (50%)<br />
            </p>
        </div>
        <div class="clear"></div>
        <p style="margin-left: 109px;">
            <span style="margin-left: 20px;">Northeast</span><br />
            <img src="./assets/img/destaques/seta.png" class="setaList"><b>Low</b> (61%)<br />
        </p>
        <p style="margin-top: 30px">
            <span>South, Southeast and Central-West:</span><br />
            <img src="./assets/img/destaques/seta.png" class="setaList">None of the municipalities is in the <b>Very Low</b> category<br />
        </p>
        <p>
            <span>North and Northeast:</span><br />
            <img src="./assets/img/destaques/seta.png" class="setaList">None of the municipalities is in the <b>Very High</b> category<br />
        </p>
    </div>
