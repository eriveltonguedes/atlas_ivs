...
require_once 'controller/PerfilRM.class.php';
...
<?php if ($MunicipioPefil != null) { ?>
    <a href="<?php echo $path_dir . "perfil_print/" . $MunicipioPefil ?>" target="_blank" onMouseOver="document.images['iconPerfilImpressao'].src = 'assets/img/icons/print_gray.png';" onMouseOut="document.images['iconPerfilImpressao'].src = 'assets/img/icons/print_gray.png';">            
