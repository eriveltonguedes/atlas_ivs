    ...
    <div class="containerPerfilTopPrint">
        <div class="containerTitlePagePrint">
            <div style="margin-top: -10px; float: right; width: 144px;"> 
                <a onclick="javascript:self.print();" style="cursor: pointer;" onMouseOver="document.images['iconPerfilImpressao'].src = 'assets/img/icons/print_gray.png';" onMouseOut="document.images['iconPerfilImpressao'].src = 'assets/img/icons/print_gray.png';">
                ...
                <?php
                    ...
                    $ufCru = $divisao[1];
                ?>
                <a href="http://pdfcrowd.com/url_to_pdf/?pdf_name=AtlasIDHM2013_Perfil_<?php echo $nomeCru . "_". $ufCru;?>&footer_text=Pag.%p%20de%n%20" onMouseOver="document.images['iconPerfilDownload'].src = 'assets/img/icons/download_gray.png';" onMouseOut="document.images['iconPerfilDownload'].src = 'assets/img/icons/download_gray.png';">
                    <div class="btn_print" data-original-title='Download PDF' style="margin-right: 10px; margin-top: 14px;" id='toolTipDown'>
                        ...
                        <!--<a href="http://pdfcrowd.com/url_to_pdf/" onMouseOver="document.images['iconPerfilDownload'].src = 'img/icons/downloaddown.png';" onMouseOut="document.images['iconPerfilDownload'].src = 'img/icons/download.png';">-->
                            <img src="assets/img/icons/download_gray.png"/>
                        </button>
                    </div>
                </a>
            </div>
