...
<div style="font-weight: bold">Human Development, HDI and MHDI<br /><br /></div>    
<ul class="nav navbar-nav">
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#1">What is Human Development?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#2">What is the Human Development Index (HDI)?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#3">What is the Municipal Human Development Index (MHDI)?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#4">Why the MHDI? </a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#5">What is the difference between HDI and MHDI? </a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#6">Why adapt the global HDI to the municipal level?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#7">Is it possible to compare global HDI and MHDI?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#8">Why is the global HDI of Brazil (published annually by UNDP) different from Brazil’s MHDI presented in Atlas?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#9">Why are the values of the indicators that compose Brazil’s MHDI different from those that make up Brazil’s HDI, published by the UNDP?</a></li>
</ul>
<div style="font-weight: bold">MHDI’s calculation methodology<br /><br /></div>
<ul class="nav navbar-nav">
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#10">How is the MHDI calculated?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#11">Do the three dimensions have the same weight?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#12">Has the methodology for calculating the MHDI always been the same? Why have there been changes in the indicators that compose the index?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#13">Why was the geometric mean used to combine the components of MHDI?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#14">Is it possible to compare the MHDI 2013 with the 1991 and 2000 MHDIs, published in 2003?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#15">Why is the municipalities’ ranking in 1991 and/or 2000 different in this new Atlas 2013 when compared to the rankings published in previous Atlas editions?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#16">Can the income per capita be used as a proxy to measure human development?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#17">Why does the MHDI not include dimensions such as social participation, gender and equity?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#18">Can there be a tie between municipalities in the MHDI classification? Why?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#19">How the municipalities are classified into the human development categories? </a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#20">Is the MHDI sufficient to measure the level of human development of a municipality?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#21">Is the MHDI able to capture short-term progress in the municipalities?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#22">What does Brazil’s MHDI mean? Is it an average of the MHDIs of all municipalities?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#23">How were the maximum and the minimum values of each dimension chosen? How were they calculated?</a></li>
</ul>
<div style="font-weight: bold">Human Development, HDI and MHDI<br /><br /></div>
<ul class="nav navbar-nav">
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#24">What is the Atlas of Human Development in Brazil 2013??</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#25">Who developed the Atlas of Human Development in Brazil 2013?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#26">What is the Atlas?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#27">For whom is the Atlas of Human Development designed?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#28">Where does the data used in the Atlas come from?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#29">Why are the Atlas data and the MHDI published only once every 10 years?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#30">How many municipalities are included in Atlas Brazil 2013?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#31">My municipality did not exist in 2000 (or in 1991), how come this data is, however, presented in Atlas? What is territorial compatibilisation?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#32">What is the municipal profile?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#33">How is Atlas Brazil 2013 related to the Millennium Development Goals?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#34">What other kind of data is found in the Atlas Brazil 2013, in addition to the MHDI?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#35">I do not have internet access. Can I still use Atlas Brazil 2013?</a></li>
</ul>
<div style="font-weight: bold">The Atlas of Brazilian Metropolitan Areas<br /><br /></div>
<ul class="nav navbar-nav">
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#36">What is the Atlas of the Metropolitan Areas?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#37">When will the Atlas of the Metropolitan areas be available?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#38">What metropolitan area data will be provided?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#39">My questions were not included in the FAQ. Who do I contact for further questions and clarification?</a></li>
</ul>
<div style="font-weight: bold">User’s guide for Atlas Brazil 2013<br /><br /></div>
<ul class="nav navbar-nav">
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#40">How do I make a query about my municipality?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#41">How do I display the data of my municipality on a map?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#42">How do I download the tables?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#43">How do I search the Municipal Profile of my municipality?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#44">How do I print the Municipal Profile?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#45">How do I view the ranking position of my municipality?</a></li>
    <li><a href="<?php echo $path_dir.$_SESSION['lang']; ?>/o_atlas/perguntas_frequentes/#46">How do I follow the evolution of the indicators over the years?</a></li>
</ul>
