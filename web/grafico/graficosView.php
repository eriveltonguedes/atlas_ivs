...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $("#imgTab3").attr("data-original-title", lang_mng.getString("graficos_arvore"));
...
//            consulta_();
    ...
    function changeAba_(switcher, t) {
        ...
        if (switcher == 1) {
            $("#imgTab6").show();
            $(b).html('<img src="./assets/img/icons/lines_gray.png">');
            $(t).html('<img src="./assets/img/icons/scatter_plot_white.png">');
            $(t).tooltip('hide')
            $("#form1").show();
            $("#form2").show();
            $('#btnPrintMap').show();
            ...
            $("#imgTab6").hide();
            $(b).html('<img src="./assets/img/icons/scatter_plot_gray.png">');
            $(t).html('<img src="./assets/img/icons/lines_white.png">');
            $("#form1").hide();
            $("#form2").hide();
            $('#btnPrintMap').show();
            ...
            window.location.assign(path_dir + lang + '/arvore/');
        }
//        else if(switcher == 3){
//            $("#imgTab6").hide();
        ...
        <div class="containerTitlePage">
            ...
            <div class="iconAtlas">
                <button type="button" name="" value="" class="gray_button small_bt" style="margin-right: 5px;" id="imgTab1"  data-original-title='' title data-placement='bottom' onclick="changeAba_(1, this);">
                    <img src="./assets/img/icons/scatter_plot_gray.png">
                </button>
                <button type="button" name="" value="" class="gray_button small_bt" style="margin-right: 5px;" id="imgTab2" onclick="changeAba_(2, this);" data-original-title='' title data-placement='bottom'>
                    <img src="./assets/img/icons/lines_gray.png">
                </button>
                <button type="button" name="" value="" class="gray_button small_bt" id="imgTab3" onclick="changeAba_(3, this);" data-original-title='' title data-placement='bottom'>
                    <img src="./assets/img/icons/tree_gray.png">
                </button>
            </div>
        </div>
    </div>
