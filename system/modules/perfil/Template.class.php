<?php
    ...
    require_once PERFIL_PACKAGE . "IDisplayTemplate.class.php";
...
class Template implements IDisplayTemplate {
    ...
    public function __construct($id) {
        ...
        if(file_exists(PERFIL_PACKAGE."view/templates/Template_$idTemplate.html"))
            $this->html = file_get_contents(PERFIL_PACKAGE."view/templates/Template_$idTemplate.html");
        elseif(file_exists(PERFIL_PACKAGE."view/templates/Template_$idTemplate.php"))
            $this->html = file_get_contents(PERFIL_PACKAGE."view/templates/Template_$idTemplate.php");
        else
