...
function getChartEvolucao($idMunicipio, $lang, $type) {
...
function getChartEscolaridadePopulacao($idMunicipio, $lang) {
    ...
    if ($lang == "pt"){
		...
		<div><img src='./assets/img/perfil/25_ou_mais.png' width='736' height='47' style='margin-left:95px; margin-bottom:-25px; z-index:1; position:relative;'/></div>
    ...
    return "<div id='chart_escola' style='width:100%; height: 330px'>
		<div><img src='./assets/img/perfil/25_ou_mais_en.png' width='736' height='47' style='margin-left:95px; margin-bottom:-25px; z-index:1; position:relative;'/></div>
                <div id='chartEscolaridadePop91' style='width: 360px; height: 283px; float:left; position:none;'>            
                    <input id='freq_1991' type='hidden' value=' " . $freq_1991 . "' /> 
                </div>
                <div id='chartEscolaridadePop00' style='width: 285px; height: 283px;float:left; position:none;'>            
    ...
    return "<div id='chart_escola' style='width:100%; height: 330px'>
		<div><img src='./assets/img/perfil/25_ou_mais_es.png' width='736' height='47' style='margin-left:95px; margin-bottom:-25px; z-index:1; position:relative;'/></div>
                <div id='chartEscolaridadePop91' style='width: 360px; height: 283px; float:left; position:none;'>            
                    <input id='freq_1991' type='hidden' value=' " . $freq_1991 . "' /> 
                </div>
                <div id='chartEscolaridadePop00' style='width: 285px; height: 283px;float:left; position:none;'>            
...
function getChartTrabalho($idMunicipio, $lang) {
    ...
    if ($lang == "pt"){
		...
		<div><img src='./assets/img/perfil/pop_econ_ativa.png' width='348' height='57' style='margin-left:80px'/></div>	
		...
		<div><img src='./assets/img/perfil/pop_econ_ativa_en.png' width='348' height='57' style='margin-left:80px'/></div>	
         <div id='chart_trab' style='width: 100%; height: 457px; margin-left:8%;'> 
               <div id='chart_trabalho' style='width: 500px; height: 500px; float:left;' >
                    <input id='trabalho_perfil' type='hidden' value=' " . $trabalho . "' /> 
                </div>
		...
		<div><img src='./assets/img/perfil/pop_econ_ativa_es.png' width='348' height='57' style='margin-left:80px'/></div>	
         <div id='chart_trab' style='width: 100%; height: 457px; margin-left:8%;'> 
               <div id='chart_trabalho' style='width: 500px; height: 500px; float:left;' >
                    <input id='trabalho_perfil' type='hidden' value=' " . $trabalho . "' /> 
                </div>
