...
//     require_once MOBILITI_PACKAGE.'util/protect_sql_injection.php';
	...
	require_once "../../../../com/mobiliti/consulta/man_bd.class.php";
...
//    $bd->insert($SQL);
	...
	function getNav(){
		...
		$browsers['Lynx']               = 'Lynx';
		$browsers['mobilexplorer']      = 'Mobile Explorer'; // Movel
		$browsers['Mobile Safari']      = 'Mobile Safari'; // Movel
		$browsers['MSIE']               = 'Internet Explorer';
		$browsers['Netscape']           = 'Netscape';
		$browsers['OmniWeb']            = 'OmniWeb';
		$browsers['Opera']              = 'Opera';
		$browsers['operamini']          = 'Opera Mini'; // Movel
		$browsers['opera mini']         = 'Opera Mini'; // Movel
