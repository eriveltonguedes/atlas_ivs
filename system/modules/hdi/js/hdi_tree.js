...
function set_dropdowns(){
    $.post("system/modules/hdi/ano.php",function(valor){
        $("select[name='ano1']").html(valor);
        $("select[name='ano2']").html(valor);
    })
    $.post("system/modules/hdi/estado.php",function(valor){
...
function dados_defaults(){
    if(!tree_options[0]){
        $.post("system/modules/hdi/estadoSearch.php",{municipio:getCookie("usercityid")},function(valor){
            var x = valor.split("|");
            $.post("system/modules/hdi/municipio.php",{estado:x[1]},function(valorr){
...
function dados(){
	...
	municipio1aux = municipio1;
            if(espacialidade1 == 'municipio'){
                $.post("system/modules/hdi/consulta.php",{ano:ano1,municipio:municipio1, espac: 'municipio'},function(valor){
                    da = valor.split("|");
                    refresh();
                })
            }
            else if(espacialidade1 == 'estado'){
                $.post("system/modules/hdi/consulta.php",{ano:ano1,municipio:municipio1, espac: 'estado'},function(valor){
                    da = valor.split("|");
                    refresh();
                })
            }
...
//            }
	...
	municipio2aux = municipio2;
            if(espacialidade2 == 'municipio'){
                $.post("system/modules/hdi/consulta.php",{ano:ano2,municipio:municipio2, espac: 'municipio'},function(valor){
                    da2 = valor.split("|");
                    refresh();
                })
            }
            else if(espacialidade2 == 'estado'){
                $.post("system/modules/hdi/consulta.php",{ano:ano2,municipio:municipio2, espac: 'estado'},function(valor){
                    da2 = valor.split("|");
                    refresh();
                })
            }
...
function loading(left){
    ...
    paper.image("assets/img/load.gif", trunk_position - 31, paper_h - 70, 40, 40);
}
