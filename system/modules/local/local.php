<?php
    ...
    {  
        ...
        $sql = "select id,rmcurto from rm order by rmcurto";
        ...
        {  
            while( $dados = pg_fetch_object($q) )  
            {    
                $json[] = Array('n'=> $dados->rmcurto, 'id'=> $dados->id);
            }  
        }  
    ...
    $json = (object)Array('estados'=>loadEstados(),'regioes'=>loadRegioes(),'areasTematicas'=>loadAreasTematicas(),'rms'=>loadRms());
