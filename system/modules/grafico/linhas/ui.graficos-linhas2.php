                ...
                <table>
                    <tr style="">
                        <td colspan="4">
                            ...
                            <div id="chart_divLinha" style='width: 600px; height: 500px; margin-left: 80px; border: 1px solid #cccccc; margin-top: 10px;'>
                                <img id="uilinhaloader" src="assets/img/icons/ajax-loader.gif" style="background-color: transparent; margin-top: 250px; margin-left: 270px;" />
                            </div>
                        </td>
                    </tr>
                </table>
