...
function csv_build(){
    ...
    //console.log(TableComponent.getOrderObject());
    var orr = TableComponent.getOrderObject();
    //console.log(orde['id']);
    if(orr){
		if(orr['id']!="espacialidades")
			ordena = orr['id']+"_"+orr['order'];
		else
			ordena = "0_0_"+orr['order'];
    }else
		ordena="0_0_ASC";
    ...
    try{
        ...
        $.ajax({
            ...
            data:{
                ...
                'atpagina' : -1,
                'atord':ordena,
                'col_download':lang_mng.getString("col_download_csv")
            },
