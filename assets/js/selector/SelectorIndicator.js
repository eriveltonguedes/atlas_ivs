...
function SelectorIndicator(selectorArea,listArea,inputSearch,selectionListener,changeListListener,multiSelect,options){
    ...
    function _construct_selector(){ 
        ...
        search.html("<input id='input_search_intern_list' style='background: url(assets/img/icons/lupa.png) no-repeat scroll 97% 7px; padding-right:25px;' type='text' size='50' value=''></input>");
...
//       }
    ...
    function  _on_click_evt(e)
    {
        ...
        //se for necessário desmarcar
         $("#" + _listArea  +" li").each(function() 
         {
               ...
               {    
                   if(!_multiSelect)
                   {
                       $("#ipt_li_input_" + cont).css("list-style-image","url('assets/img/selector/white.jpg')");
                   }
        ...
        else //se não houver options disparar evento logo
        {
            ...
            $("#" + attr_id).css("list-style-image","url('assets/img/selector/check.jpg')");
    ...
    function _option_clk_evt(e)
    {
        ...
        $("#" + _hide_popover).css("list-style-image","url('assets/img/selector/check.jpg')");
