...
var inputHandler = {
    ...
    function searchTimed(atual,listner){
        ...
        $.ajax({
            ...
            url:'system/modules/tabela/util/AjaxSearchString.php',
            success: function(retorno){
                ...
                else if (atual.attr("in") == 6 || atual.attr("in") == 4){
                     for (var i in Obj){
                        atual.removeClass('erroInput');
                        divAdd += "<div i='"+Obj[i].id+"' id-m='"+atual.attr("id")+"' url='"+(replaceAllChars(' ','-',Obj[i].nome)).toLowerCase().replace("\'", '')+"' class='divResultsPopUp' onclick=\"setTextInput('"+atual.attr("id")+"','municipio',this,"+listner+")\">"+Obj[i].nome+"</div>";
                    }
                }
                else{
                    for (var i in Obj){
                        ...
                        if((nome == 'São Paulo' & id == '17') | (nome == 'Rio de Janeiro' & id == '16') | nome == 'Rondônia' | nome == 'Minas Gerais' | (nome == 'Paraná' & id == '3') |
                            ...
                            divAdd += "<div i='"+Obj[i].id+"' id-m='"+atual.attr("id")+"'url='"+Obj[i].id+"'  class='divResultsPopUp' onclick=\"setTextInput('"+atual.attr("id")+"','municipio',this,"+listner+")\">"+Obj[i].nome+" ("+Obj[i].uf+")</div>";
                        }
                    }
                }
