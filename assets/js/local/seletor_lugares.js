...
function LocalSelector()
{
    ...
    */
    ...
    function startPopOver()
    {
        ...
        else if(espacialidade_selecionada == 6)
        {
           filterByBox2(rm,espacialidade_selecionada);
        }
    ...
    function dispatchListener(listener)
    {
        ...
        var lugar_rm = new Lugar();
        lugar_rm.e = 6;
        lugar_rm.ac = false;
        lugar_rm.l = locais_rm;
        ...
        listener([lugar_municipal,lugar_estadual,lugar_rm,lugar_area_tematica]);
    }
    ...
    function fillData(data)
    {
        ...
        rm = injetaEspacialidade(data.rms,6);
        if(rm.length > 1)
        {
            var value = [];

            value.n = "Todas as RMs";
            value.id = '-1';
            var newArray = [value];
            rm = newArray.concat(rm);
        }
    ...
    function fillFiltroBox1(array)
    {
        ...
        $(this_selector_element).find('.box1 ul li').click(function(e)
        {
            ...
            else if(valorSelecionadoBox1 == 6)
            {
                rm[0].n = 'Marcar todos';
                $(this_selector_element).find('.box2 ul li[data-id = -1]').html('Marcar todos');
                $(this_selector_element).find('.box2 .title_box').html('Região Metropolitana');
                $(this_selector_element).find('.box3 .title_box').html('');   
            }
            ...
            $(this_selector_element).find('.box2 ul li').click(function(e)
            {
                ...
                if(valorSelecionado == -1)
                {
                    $.each($(this_selector_element).find('.box2 ul li'),function(pos,itemList)
                    {
                        ...
                        objeto.id = id;
                        objeto.n = $(this).text();
                        objeto.e = 6; //espacialidade regiao metropolitana
